...
public final class Util {
    ...
    static String getAvailablePath(Context context) {
		...
		//add by wzb for mtk_shard_sdcard use /data/media/0
		if(SystemProperties.get("ro.mtk_shared_sdcard").equals("1")){
			sAvailablePath="/data/media/0";
		}
		//end--
    ...
    public static boolean isSharedSdcard() {
        ...
        //return ret;
        return false;//modify by wzb 20150919 
    }
    ...
    public static boolean is2SdcardSwap() {
        ...
        //return ret;
        return false;//modify by wzb 20151014
    }
