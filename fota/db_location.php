...
$watch_utc_time = isset($_POST['watch_utc_time']) ? $_POST['watch_utc_time'] : '';
$watch_longtitude = isset($_POST['watch_longtitude']) ? $_POST['watch_longtitude'] : '';
$watch_latitude = isset($_POST['watch_latitude']) ? $_POST['watch_latitude'] : '';
$watch_imei = isset($_POST['watch_imei']) ? $_POST['watch_imei'] : '';
...
//} else if (isset ( $userName ) && isset ( $passWord ) && strlen ( $userName ) > 0 && strlen ( $passWord ) > 0) 
{
	...
	$sql1 = 'insert into WatchLocations (userid , longitude , latitude , datetime) values("' . $watch_imei . '","' . $watch_longtitude . '","' . $watch_latitude . '","' . $watch_utc_time . '")';
	//$sql1 = 'insert into WatchLocations values(5,2,3,4,5)';
        ...
        if (mysql_affected_rows () == 1) {
            ...
            echo "<table align='center'><tr><td height='10px'></td></tr><tr><td><font color='#FF0000'>username and password is uncorrect??????!</font></td></tr></table>";
        }
    }
}
  ...
  <div class="change">
    <table align='center'>
      ...
      <tr>
        ...
        <td align='center'>
          <table align='center'>
            <form action=<?php echo $basesslurl.'db_location.php'?> method='post'>
              <tr>
